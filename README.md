Code in this repository generates an interactive map to visualize the Democratic governor's race. It uses the following data, which is copied into the repository:
